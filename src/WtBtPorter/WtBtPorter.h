...
#pragma region "CTA接口"
	...
	EXPORT_FLAG	void		cta_set_position(CtxHandler cHandle, const char* stdCode, double qty, bool insert_mongo, const char* uesrTag, double limitprice, double stopprice);
